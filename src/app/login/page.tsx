...
　//export default 以下が処理の場所(returnの前)
 ...
 const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        //signInWithPassword: メールアドレスとパスワードでログイン
      ...
      // errがErrorオプジェクトならそのmessageを使う
      // そうでない場合はデフォルトメッセージ
    } finally {
      // 処理完了後、ローディング終了
      //finally = tryてせもcatchでも最後に必ず実行される
      setLoading(false);
    }
      } ;
